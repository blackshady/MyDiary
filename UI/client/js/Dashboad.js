...
const storyTitle = document.querySelector('.story__title').value;
const storyText = document.querySelector('.story__text').value;
...
document.addEventListener('DOMContentLoaded', (e) => new Dashboard());